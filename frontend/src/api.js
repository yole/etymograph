...
export function updateLanguage(lang, letterNorm, phonemeClasses, diphthongs) {
    return postToBackend('language/' + lang,
        {letterNormalization: letterNorm, phonemeClasses: phonemeClasses, diphthongs: diphthongs}
    )
}
